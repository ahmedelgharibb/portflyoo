...
function setupPasswordChange() {
    ...
    if (resetPasswordForm) {
        resetPasswordForm.addEventListener('click', resetPasswordFormFields);
    }
...
async function handlePasswordChange(e) {
    ...
    if (!validatePasswordStrength()) {
        showAdminAlert('error', 'New password does not meet strength requirements');
        return;
    }
    
    // Validate password match
    if (!validatePasswordMatch()) {
        showAdminAlert('error', 'New passwords do not match');
        return;
    }
    ...
    try {
        ...
        if (result.success) {
            ...
            showAdminAlert('error', result.message || 'Failed to change password');
        }
    } catch (error) {
...
function resetPasswordFormFields() {
    ...
    if (form) {
        ...
        showAdminAlert('info', 'Password form reset');
    }
}
